        ...
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <canvas id="transaction-history" class="transaction-chart chartjs-render-monitor" width="467"
                        height="233" style="display: block; width: 467px; height: 233px;"></canvas>
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                        <div class="text-md-center text-xl-left">
                            <h6 class="mb-1">Transfer to Paypal</h6>
                            <p class="text-muted mb-0">07 Jan 2019, 09:12AM</p>
                        </div>
                        <div class="align-self-center grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                ...
                <div class="card-body">
                    ...
                    <div class="preview-list">
                        <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-flex grow">
                                <div class="grow">
                ...
                <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel owl-loaded owl-drag"
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(-1907px, 0px, 0px); transition: 0.25s; width: 3339px;">
                                <div class="owl-item cloned" style="width: 466.984px; margin-right: 10px;">
                                    <div class="item">
                                ...
                                <div class="owl-item" style="width: 466.984px; margin-right: 10px;">
                                    <div class="item">
                                ...
                                <div class="owl-item active" style="width: 466.984px; margin-right: 10px;">
                                    <div class="item">
                                        <img src="assets/images/dashboard/img_6.jpg" alt="">
                                    </div>
                                </div>
